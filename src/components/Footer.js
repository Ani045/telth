        ...
        <div className="container mx-auto px-6">
          <div className="py-6 flex flex-wrap justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap items-center gap-8">
              <a href="tel:+18005700140" className="flex items-center gap-3 text-black/70 hover:text-black transition-colors group">
              ...
              <a href="mailto:contact@telth.care" className="flex items-center gap-3 text-black/70 hover:text-black transition-colors group">
                <span className="p-2 rounded-lg bg-black/5 group-hover:bg-black/10 transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-4">
              <a href="/about-us" className="px-6 py-2.5 text-sm font-medium bg-white hover:bg-purple-700 hover:text-white rounded-lg transition-colors">
                About Us
              </a>
              <a href="/contact-us" className="px-6 py-2.5 text-sm duration-300 font-medium bg-gradient-to-r from-indigo-300 to-violet-300 hover:from-indigo-400 hover:to-violet-400 text-black rounded-lg transition-all shadow-lg shadow-purple-900/10">
                Contact Us
              </a>
            </div>
          </div>
      ...
      <div className="relative container mx-auto px-6 pt-16 pb-12">
          ...
          <div className="lg:col-span-2">
            <a href="/" className="inline-block mb-6">
              <div className="flex items-center">
                ...
                <span className="text-3xl font-bold bg-gradient-to-r from-purple-800 to-indigo-600 bg-clip-text text-transparent">
                  Telth.care
                </span>
              </div>
            </a>
        ...
        <div className="pt-8 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-black/60 text-sm">
            © 2024 Telth.care. All rights reserved.
          </p>
          <p className="text-black/60 text-sm">
